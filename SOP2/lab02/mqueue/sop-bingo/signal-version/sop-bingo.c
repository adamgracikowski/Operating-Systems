...
void bingo_server(mqd_t pout);
void bingo_sigroutine(int sig, siginfo_t *info, void *context);

volatile sig_atomic_t messages_received = 0;
...
int main(int argc, char **argv)
{
    ...
    sethandler(bingo_sigroutine, SIGUSR1);
